...
# Top-SNPs that have no neighboring SNP with at least suggestive significance are filtered
# out and a new ID is introduced to keep continuous enumeration.
#
#
# Notes:
...
# copy old ids and create new continuous ones
