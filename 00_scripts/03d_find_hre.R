...
# Date: 2024-04-18
#
# Script Description: Perform a look up of the candidate gene in references that list
# AREs and EREs.
#
#
# Notes: Script needs a table with the candidate genes for each locus to look up (one gene per row)
...
# VARIABLES ---------------------------------------------------------------
gene_annotation_file = "additional_information/gene_table_hre_search.xlsx" # a manually created table consisting of a list of genes selected for HRE search (e.g. all genes near variants of the CS)
...
for (row in 1:nrow(gene_list)) {
  # look up how many AREs are in the vicinity of the genes and what their tier is
  ...
  # look up of AREs that overlap with KLF sites (and check whether a regulation
