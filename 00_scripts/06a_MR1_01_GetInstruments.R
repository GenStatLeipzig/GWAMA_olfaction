#' ---
#' title: "Mendelian Randomization - extract instruments for sex homones"
...
#'
#' the following decision on the instrument selection was made:
#'
...
dumID41 = myColoc[
  PP.H4.abf > 0.5 & bestSNP_trait2_zscore < bestSNP_trait1_zscore,
...
#' Coloc was performed for TT, BAT and SHBG, because data from men and women are available. E2 is only available in men, hence I can simply pick the best SNP per cytoband
#'
