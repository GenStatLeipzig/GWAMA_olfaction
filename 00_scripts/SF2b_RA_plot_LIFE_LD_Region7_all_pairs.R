...
# Date: 2024-01-11
#
# Script Description: Make RA plots of region 7 by manually specifying all necessary pairs of SNPs for LD visualization.
#
#
# Notes:
...
#####
# 1. define plot function and important variables
#####
