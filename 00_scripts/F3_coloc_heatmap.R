...
#
# Notes:
# TODO before executing the script manually add the results for significance and
# higher sex effect from the sex-interaction test output to the coloc results
...
# change color of region labels according to results of sex IA test
