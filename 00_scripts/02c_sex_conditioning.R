...
# Date: 2024-05-24
#
# Script Description: For loci with different signals in males and females perform conditioning on the sex-top SNPs to check whether they keep their significance
#
#
# Notes:
...
l_sig_diff = c(6, 11) # loci with strongest support in H3
...
prepare_cojo_data = function(f) {
  ...
  cojo_input = data_tmp[
    (chrom == region_chrom) & (pos >= region_start) & (pos <= region_end),
